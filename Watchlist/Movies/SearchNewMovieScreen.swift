...
struct SearchNewMovieScreen: View {
    // Environment
    ...
    var body: some View {
        ZStack {
            VStack {
                createSearchTextField(fieldText: "Enter Movie")
    ...
    private func displayRankedTextField() -> some View {
        ...
        } else if searchResultData.isEmpty && newMovie.isEmpty == false {
